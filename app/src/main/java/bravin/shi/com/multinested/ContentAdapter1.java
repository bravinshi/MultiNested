...
public class ContentAdapter1 extends SimpleRecyclerViewAdapter<DataBean> {
    private static final String TAG = "Multi";
    private Context context;
    private int[] colors = new int[]{Color.DKGRAY, Color.CYAN};
    private static int count = 0;

    public ContentAdapter1(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        count++;
//        Log.d(TAG, "ContentAdapter1 " + count);
