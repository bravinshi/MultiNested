...
public class ContentAdapter2 extends SimpleRecyclerViewAdapter<DataBean> {
    private static final String TAG = "Multi";
    private Context context;
    private int[] colors = new int[]{Color.LTGRAY, Color.MAGENTA};
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        count++;
        Log.d(TAG, "ContentAdapter2 " + count);
